...
public interface EXTLibraryPackage extends EPackage
{
  ...
  /**
	 * The meta object id for the '{@link org.eclipse.emf.examples.extlibrary.Identifiable <em>Identifiable</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.emf.examples.extlibrary.Identifiable
	 * @see org.eclipse.emf.examples.extlibrary.impl.EXTLibraryPackageImpl#getIdentifiable()
	 * @generated
	 */
	int IDENTIFIABLE = 0;
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int ITEM__PUBLICATION_DATE = IDENTIFIABLE_FEATURE_COUNT + 0;
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int ITEM_FEATURE_COUNT = IDENTIFIABLE_FEATURE_COUNT + 1;
  ...
  /**
	 ...
	 * @ordered
	 */
	int ADDRESSABLE__ID = IDENTIFIABLE__ID;
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int ADDRESSABLE__ADDRESS = IDENTIFIABLE_FEATURE_COUNT + 0;
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int ADDRESSABLE_FEATURE_COUNT = IDENTIFIABLE_FEATURE_COUNT + 1;
  ...
  /**
	 ...
	 * @ordered
	 */
	int LIBRARY__ID = ADDRESSABLE__ID;
  ...
  /**
	 ...
	 * @ordered
	 */
	int PERSON__ID = ADDRESSABLE__ID;
  ...
  /**
	 ...
	 * @ordered
	 */
	int LENDABLE__ID = IDENTIFIABLE__ID;
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int LENDABLE__COPIES = IDENTIFIABLE_FEATURE_COUNT + 0;
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int LENDABLE__BORROWERS = IDENTIFIABLE_FEATURE_COUNT + 1;
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int LENDABLE_FEATURE_COUNT = IDENTIFIABLE_FEATURE_COUNT + 2;
  ...
  /**
	 ...
	 * @ordered
	 */
	int AUDIO_VISUAL_ITEM__ID = CIRCULATING_ITEM__ID;
  ...
  /**
	 ...
	 * @ordered
	 */
	int BOOK_ON_TAPE__ID = AUDIO_VISUAL_ITEM__ID;
  ...
  /**
	 ...
	 * @ordered
	 */
	int VIDEO_CASSETTE__ID = AUDIO_VISUAL_ITEM__ID;
  ...
  /**
	 * Returns the meta object for class '{@link org.eclipse.emf.examples.extlibrary.Identifiable <em>Identifiable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	EClass getIdentifiable();
		...
		/**
	 * Returns the meta object for the attribute '{@link org.eclipse.emf.examples.extlibrary.Identifiable#getId <em>Id</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Id</em>'.
	 * @see org.eclipse.emf.examples.extlibrary.Identifiable#getId()
	 * @see #getIdentifiable()
	 * @generated
	 */
  ...
  {
    /**
		 * The meta object literal for the '{@link org.eclipse.emf.examples.extlibrary.Identifiable <em>Identifiable</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.emf.examples.extlibrary.Identifiable
		 * @see org.eclipse.emf.examples.extlibrary.impl.EXTLibraryPackageImpl#getIdentifiable()

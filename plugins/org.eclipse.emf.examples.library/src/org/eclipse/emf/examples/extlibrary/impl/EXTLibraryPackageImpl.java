...
import org.eclipse.emf.examples.extlibrary.Identifiable;
...
public class EXTLibraryPackageImpl extends EPackageImpl implements EXTLibraryPackage
{
  ...
  public void initializePackageContents()
  {
		...
		itemEClass.getESuperTypes().add(this.getIdentifiable());
		addressableEClass.getESuperTypes().add(this.getIdentifiable());
		...
		lendableEClass.getESuperTypes().add(this.getIdentifiable());
		...
		initEAttribute(getIdentifiable_Id(), ecorePackage.getEString(), "id", null, 1, 1, Identifiable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

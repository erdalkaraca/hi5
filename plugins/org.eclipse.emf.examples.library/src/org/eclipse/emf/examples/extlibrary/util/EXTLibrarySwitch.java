...
public class EXTLibrarySwitch<T> extends Switch<T> {
  ...
  {
		switch (classifierID) {
			case EXTLibraryPackage.IDENTIFIABLE: {
			...
			case EXTLibraryPackage.ADDRESSABLE: {
				...
				if (result == null) result = caseIdentifiable(addressable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EXTLibraryPackage.LENDABLE: {
				...
				if (result == null) result = caseIdentifiable(lendable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EXTLibraryPackage.CIRCULATING_ITEM: {
				...
				if (result == null) result = caseIdentifiable(circulatingItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EXTLibraryPackage.PERIODICAL: {
				...
				if (result == null) result = caseIdentifiable(periodical);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EXTLibraryPackage.AUDIO_VISUAL_ITEM: {
				...
				if (result == null) result = caseIdentifiable(audioVisualItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EXTLibraryPackage.BOOK_ON_TAPE: {
				...
				if (result == null) result = caseIdentifiable(bookOnTape);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EXTLibraryPackage.VIDEO_CASSETTE: {
				...
				if (result == null) result = caseIdentifiable(videoCassette);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EXTLibraryPackage.BORROWER: {
				...
				if (result == null) result = caseIdentifiable(borrower);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EXTLibraryPackage.EMPLOYEE: {
				...
				if (result == null) result = caseIdentifiable(employee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
